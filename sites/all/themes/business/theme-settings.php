 ...
 *   The form state.
 */
function my_business_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['busi_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('my_business Theme Settings'),
    '#collapsible' => FALSE,
    '#collapsed' => FALSE,
  );
  ...
  $form['busi_settings']['slideshow']['slideshow_display'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_display','my_business'),
  ...
  $form['busi_settings']['slideshow']['slide1']['slide1_desc'] = array(
    ...
    '#default_value' => theme_get_setting('slide1_desc','my_business'),
  );
  $form['busi_settings']['slideshow']['slide1']['slide1_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide1_url','my_business'),
  );
  ...
  $form['busi_settings']['slideshow']['slide2']['slide2_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide2_desc','my_business'),
  );
  $form['busi_settings']['slideshow']['slide2']['slide2_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide2_url','my_business'),
  );
  ...
  $form['busi_settings']['slideshow']['slide3']['slide3_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide3_desc','my_business'),
  );
  $form['busi_settings']['slideshow']['slide3']['slide3_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide3_url','my_business'),
  );
  $form['busi_settings']['slideshow']['slideimage'] = array(
    '#markup' => t('To change the Slide Images, Replace the slide-image-1.jpg, slide-image-2.jpg and slide-image-3.jpg in the images folder of the my_business theme folder.'),
  );
  ...
  $form['busi_settings']['footer']['footer_copyright'] = array(
    ...
    '#default_value' => theme_get_setting('footer_copyright','my_business'),
  ...
  $form['busi_settings']['footer']['footer_credits'] = array(
    ...
    '#default_value' => theme_get_setting('footer_credits','my_business'),
    '#description'   => t("Check this option to show copyright text in footer. Uncheck to hide."),
  );
}
